        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-primary-foreground">
          <div>
            ...
            >
              ...
              <span className="text-xl font-display font-semibold">InterviewAI</span>
            </motion.div>
          </div>
          ...
          >
            ...
            <p className="text-lg text-primary-foreground/70 max-w-md">
              Practice with intelligent mock interviews tailored to your industry. 
            ...
            <div className="flex items-center gap-6 pt-4">
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full bg-primary-foreground/20 border-2 border-primary flex items-center justify-center text-xs font-medium"
                  >
                    {i}K+
                  </div>
                ))}
